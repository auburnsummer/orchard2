...
from cafe.views.pharmacy.pharmacy_bulk_transfer import pharmacy_bulk_transfer
...
urlpatterns = [
    ...
    path("pharmacy/bulk-transfer/", pharmacy_bulk_transfer, name="pharmacy_bulk_transfer"),
