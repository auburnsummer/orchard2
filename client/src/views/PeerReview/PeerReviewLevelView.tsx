...
export function PeerReviewLevelView({
  ...
  const webhookPayloads = useMemo(() => {
    ...
    const url = getLevelDownloadUrl(rdlevel);
    const color =
      approvalIntent === 10
        ? "3066993"
        : approvalIntent === -1
        ...
        <div className="relative z-10 flex flex-col items-start gap-6 md:flex-row">
          ...
          <div className="w-full flex-shrink-0 md:w-1/3">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Button
                as="a"
                href={getLevelDownloadUrl(rdlevel)}
                target="_blank"
                rel="noopener noreferrer"
                variant="primary"
                download
              ...
              <Button
                variant="secondary"
                onClick={() => {
                  clipboard.copy(getLevelDownloadUrl(rdlevel));
                }}
              >
            ...
            <div className="flex flex-col">
              <div className="mb-2 flex items-center">
                <Checkbox
                  ...
                  showDescriptionAsTooltip
                  className="mr-2"
                  description="If selected, user will be pinged about this review."
                  checked={pingUser}
                  onChange={() => setPingUser(!pingUser)}
                />
              </div>
              ...
              <div className="mb-2 flex items-center">
                <Checkbox
                  ...
                  showDescriptionAsTooltip
                  className="mr-2"
                  description="If this is the creator's first time uploading a level. Alters ping message."
