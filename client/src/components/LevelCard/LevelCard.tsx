  ...
  return (
    <article className={cc(styles.base, className)} {...rest}>
          ...
          <div className={styles.overlayButtons}>
            <button
              ...
              className={cc(
                styles.button,
                styles.copy,
                clipboard.copied && styles.copyIsClicked,
              )}
            >
            ...
            <a
              ...
              className={cc(styles.button, styles.download)}
            >
              <FontAwesomeIcon
                icon={faDownload}
      ...
      <div
        className={cc(
          styles.info,
          onClick !== undefined && styles.infoClickable,
        )}
        onClick={onClick}
      >
        <DifficultyDecorator
        ...
        <div className={styles.metadata}>
          <div className={cc(styles.metaitem, styles.authors)}>
            ...
            <ConjunctionList
              ...
              elementRender={(v) =>
                typeof v === "string" ? (
                  <UnstyledButton className={styles.metaitemButton}>
                    {v}
                  </UnstyledButton>
                ) : (
                  <></>
              ...
              literalRender={(v) => (
                <span className={styles.metaitemText}>{v}</span>
              )}
              items={level.authors}
            />
          </div>
          <div className={cc(styles.metaitem, styles.bpm)}>
            ...
            <Text className={cc(styles.metaitemText, styles.bpmText)}>
              {bpmText}
            </Text>
          </div>
          <div className={cc(styles.metaitem, styles.source)}>
            <FontAwesomeIcon icon={faDiscord} />
            <Text className={cc(styles.metaitemText, styles.sourceText)}>
              {level.club.name}
            </Text>
          </div>
          <div
          ...
          {level.seizure_warning && (
            <li>
              <span className={cc(styles.tagCaution, styles.tag)}>
                ...
                />
                <span title="This level contains visuals and sustained flashing lighting that may affect those who are susceptible to photosensitive epilepsy or have other photosensitivities.">
                  Seizure warning
                </span>
              </span>
            </li>
        ...
        {showId && <Text className={styles.id}>{level.id}</Text>}
      </div>
    </article>
  );
}
